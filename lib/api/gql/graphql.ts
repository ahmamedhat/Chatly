...
export type AddNewMessageMutation = {
  ...
  addNewMessage: {
    ...
    _id: string;
    body: string;
    from: { __typename?: "User"; name: string; _id: string };
    to: { __typename?: "User"; name: string; _id: string };
  };
};
...
export type ChatsQuery = {
  ...
  chats: Array<{
    ...
    createdAt: string;
    updatedAt: string;
    users: Array<{ __typename?: "User"; name: string }>;
    messages: Array<{
      __typename?: "Message";
      _id: string;
      body: string;
...
export type ChatQuery = {
  ...
  chat: {
    ...
    messages: Array<{
      ...
      body: string;
      createdAt: string;
      from: { __typename?: "User"; _id: string };
      to: { __typename?: "User"; _id: string };
    }>;
  };
};
...
>;
export const AddNewMessageDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
