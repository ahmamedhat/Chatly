...
export type AddNewMessageMutation = { __typename?: 'Mutation', addNewMessage: { __typename?: 'Message', _id: string, body: string, from: { __typename?: 'User', name: string, _id: string }, to: { __typename?: 'User', name: string, _id: string } } };
...
export type ChatsQuery = { __typename?: 'Query', chats: Array<{ __typename?: 'Chat', _id: string, createdAt: string, updatedAt: string, users: Array<{ __typename?: 'User', name: string }>, messages: Array<{ __typename?: 'Message', _id: string, body: string, from: { __typename?: 'User', name: string, _id: string }, to: { __typename?: 'User', name: string, _id: string } }> } | null> };
